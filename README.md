...
> I recommend checking out [Fabric](https://github.com/evaera/Fabric) which will be replacing Aurora in all of my projects as soon as it's ready for production. Rocs solves the same problems that Aurora solves, but with less assumptions and more flexibility.
